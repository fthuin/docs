...
> **NOTE**: If you have these repositories locally from previous work with the documentation, be sure the delete them and start from scratch as some old files can cause problems with the current setup.
